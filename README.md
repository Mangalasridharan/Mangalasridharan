...
### 🏭 Uptime — Maintenance Intelligence Platform
Backend system for industrial maintenance management. Real-time machine monitoring, shift-based workforce tracking, and AI-generated predictive maintenance insights.

**Stack:** Spring Boot · Spring AI · PostgreSQL · Redis · WebSocket · AWS
...
### 🧠 MaTriX AI — Edge-First Medical Triage
Multi-agent system for maternal health triage. Runs offline on consumer hardware via Ollama + MedGemma 4B. Mathematically escalates high-risk cases to AWS SageMaker — cutting cloud costs by ~80%.

**Stack:** Python · LangGraph · Ollama · AWS SageMaker · Next.js · RAG
...
### ⚙️ QueueCTL — Background Job Queue Engine
Application-agnostic job queue with CLI control. Persistent across restarts, concurrent multi-worker execution, exponential backoff retries, and a dead letter queue for failure quarantine.

**Stack:** Python · CLI · SQLite · Concurrency
...
Full-stack smart shopping system with real-time cart sync, weight-based calculations, and IoT payment trigger integration via Adafruit IO API.

**Stack:** Node.js · Express · MongoDB · IoT · REST
...
If you're building systems that matter in the physical world — let's talk.
